...
create or replace TABLE INVESTMENTS.RAW.RAW_ASSET_SEED (
	...
	ASSET_CODE_SYSTEM VARCHAR(16777216),
	ASSET_NAME VARCHAR(16777216),
	ASSET_TYPE VARCHAR(16777216)
);

create or replace TABLE INVESTMENTS.RAW.RAW_TRANSACTION_TYPE_SEED (
	TRANSACTION_TYPE VARCHAR(16777216),
	AFFECTS_QUANTITY BOOLEAN,
	AFFECTS_CASH BOOLEAN,
	EXTERNAL_CASH_FLAG BOOLEAN
);

create or replace TABLE INVESTMENTS.RAW.CORPORATE_ACTION_ADJUSTMENTS_SEED (
	CASH_FLOW_DIRECTION VARCHAR(15),
	TRANSACTION_DATE VARCHAR(10),
	TRANSACTION_TYPE_RAW VARCHAR(30),
	PRODUTO VARCHAR(100),
...
create or replace TABLE INVESTMENTS.RAW.MAP_TRANSACTION_TYPE_SOURCE_SEED (
	SOURCE_TRANSACTION_TYPE VARCHAR(100),
	SOURCE_SIDE VARCHAR(15),
...
CREATE OR REPLACE TABLE INVESTMENTS.STAGING.STG_ASSET_PRICES (
	ASSET_CODE VARCHAR(16777216),
	PRICE_DATE DATE,
	PRICE_OPEN NUMBER(10,2),
	PRICE_HIGH NUMBER(10,2),
...
create or replace TRANSIENT TABLE INVESTMENTS.STAGING.STG_TRANSACTION_TYPE (
	TRANSACTION_TYPE VARCHAR(16777216),
	AFFECTS_QUANTITY BOOLEAN,
	AFFECTS_CASH BOOLEAN,
	EXTERNAL_CASH_FLAG BOOLEAN,
...
CREATE OR REPLACE TABLE STAGING.STG_ASSET (
    ASSET_CODE VARCHAR(50) NOT NULL,
...
create or replace TABLE INVESTMENTS.STAGING.STG_TRANSACTIONS_XTB (
	...
	TRANSACTION_TYPE_RAW VARCHAR(16777216),
	TRANSACTION_TYPE VARCHAR(16777216),
...
CREATE OR REPLACE TABLE STAGING.STG_TRANSACTIONS_CLEAR (
    TRANSACTION_ID        VARCHAR(32)      NOT NULL,
    TRANSACTION_TYPE_RAW      VARCHAR(50),
    TRANSACTION_DATE      DATE             NOT NULL,
	TRANSACTION_TYPE VARCHAR(100),
    ASSET_CODE            VARCHAR(20)      NOT NULL,
    ASSET_CODE_NAME       VARCHAR(200),
    BROKER                VARCHAR(100),
...
create or replace TRANSIENT TABLE INVESTMENTS.PROD.DIM_TRANSACTION_TYPE (
...
create or replace TABLE INVESTMENTS.PROD.FCT_ASSET_PRICES (
...
create or replace TABLE INVESTMENTS.PROD.FCT_TRANSACTIONS (
	...
	PRICE NUMBER(10,2),
	AMOUNT_EUR NUMBER(11,2),
    AMOUNT_BRL NUMBER(11,2),
	COMMENT VARCHAR(16777216),
	SOURCE_FILE VARCHAR(16777216),
	SOURCE_SYSTEM VARCHAR(16777216),
	LOAD_TS TIMESTAMP_NTZ(9),
